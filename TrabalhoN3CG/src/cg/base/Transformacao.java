...
public class Transformacao {
	...
	/**
	 * Cria a matriz identidade como padrão
	 */
	...
	public Transformacao(final double[] matriz) {
		this.matriz = matriz;
	}
	...
	public void setMatriz(final double[] matriz) {
		this.matriz = matriz;
	}
	 ...
	 */
	public void transladar(final double x, final double y, final double z) {
		atribuirIdentidade();
		matriz[12] = x;
		matriz[13] = y;
		matriz[14] = z;
	 ...
	 */
	public void escalar(final double x, final double y, final double z) {
		atribuirIdentidade();
		matriz[0] =  x;
		matriz[5] =  y;
		matriz[10] = z;
	 ...
	 */
	public void rotacionarZ(final double angulo) {
		atribuirIdentidade();
	 ...
	 */
	public Transformacao transformarMatrix(final Transformacao t) {
	 ...
	 */
	public Ponto transformarPonto(final Ponto ponto) {
